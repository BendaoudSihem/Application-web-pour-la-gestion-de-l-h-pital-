...
@section('secretaire')
         ...
         <!--from pour ajouter secretaire-->
      <div class="col-xs-12"><hr><br></div>
     
       <form role="form" enctype="multipart/form-data" method="POST" action="{{url('Secretaire')}}">

           {{ csrf_field() }}

           <!--input pour entrer le nom de secretaire -->
        <div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }} col-sm-offset-1 col-sm-4">
          ...
          <input type="text" class="form-control" name="nom" id="nom" placeholder="Enter nom" value="{{ old('nom') }}" required autofocus>
           ...
           <!--input pour entrer le prenom de secretaire -->
