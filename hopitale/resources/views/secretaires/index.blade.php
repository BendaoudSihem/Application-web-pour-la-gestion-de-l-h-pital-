...
<div class="gestions">
  <div class="container">
    ...
    <h1 class="text-center">Gestion des secrétaires</h1>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
      <div class="div-square" style="text-align: center;">
        ...
        <a href="{{url('Secretaire/create')}}" >
          <i style="color:green;" class=" fa fa-user-plus  fa-5x"></i>
          <h4><b> Ajouter secrétaire</b></h4>
        </a>
         @endif
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 search-bar">
      <div class="input-group">
        <form role="form" method="POST" action="{{url('Rechercher/Secretaire')}}">
