...
@section('infermier')
         ...
         <!--afficher lesinfermiers-->
      <div class="col-xs-12" ><hr><br></div>

                    <!--afficher les 15 premiers infermiers-->
              @if($infermiers)
      ...
      <div class="col-sm-4 col-xs-6" style="text-align: center;">
        <div class="thumbnail">
          ...
          <div class="col-xs-6 caption">
            <a class="btn btn-warning" href="{{url('Infermier/'.$infermier->id.'/edit')}}">Modifier</a>
          </div>
      ...
      <div class="col-sm-offset-4 col-xs-12">
          @if($cmp>1)  
            @for($i=0; $i<=$cmp;$i++)
        <a href="{{url('Infermiers/'.$i)}}" class="btn btn-info">{{$i+1}}</a>
            @endfor
          @endif
      </div>
      <div class="col-xs-12"><br></div>
